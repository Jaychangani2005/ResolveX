            ...
            <View style={styles.achievementsList}>
              <View style={styles.achievementItem}>
                ...
                <View style={styles.achievementInfo}>
                  <Text style={styles.achievementName}>First Report</Text>
                  <Text style={styles.achievementDesc}>Submitted your first incident report</Text>
                </View>
              ...
              <View style={styles.achievementItem}>
                <Text style={styles.achievementEmoji}>🌱</Text>
                <View style={styles.achievementInfo}>
                  <Text style={styles.achievementName}>Guardian Badge</Text>
                  <Text style={styles.achievementDesc}>Reached 1000+ points</Text>
                </View>
              ...
              <View style={styles.achievementItem}>
                <Text style={styles.achievementEmoji}>📍</Text>
                <View style={styles.achievementInfo}>
                  <Text style={styles.achievementName}>Location Master</Text>
                  <Text style={styles.achievementDesc}>Captured 10+ GPS locations</Text>
                </View>
